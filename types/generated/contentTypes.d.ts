...
export interface ApiAuthorssinAuthorssin extends Struct.CollectionTypeSchema {
  collectionName: 'authorsplu';
  info: {
    displayName: 'authors';
    pluralName: 'authorsplu';
    singularName: 'authorssin';
  };
  options: {
...
export interface ApiCategoriessinCategoriessin
  extends Struct.CollectionTypeSchema {
  collectionName: 'categoriesplu';
  info: {
    displayName: 'categories';
    pluralName: 'categoriesplu';
    singularName: 'categoriessin';
  };
  options: {
    draftAndPublish: true;
  };
